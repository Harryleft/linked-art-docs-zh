...
* /classified_as/id --> /additional类型
* /identified_by[type=名称] [classified_as/id=PRIMARY_NAME]/content --> /name 
* /identified_by[type=名称]/content --> /alternate名称
* /identified_by[type=标识符]/content --> /identifier
...
* 类型 = DefinedTerm AND CreativeWork
* Additional 类型s: Language
* /broader --> /isPartOf
...
* /made_of --> /material
* /content --> /text
* /dimension[classified_as/id=HEIGHT]/值 --> /height
* /dimension[classified_as/id=WIDTH]/值 --> /width
* /dimension[classified_as/id=DEPTH]/值 --> /depth
